...
#include "SteamCore/Public/ESteamFavoriteFlags.h"
#ifdef _MSC_VER
#pragma warning (push)
#pragma warning (disable : 4883)
#endif
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeESteamFavoriteFlags() {}
...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_SteamCore_ESteamFavoriteFlags_Hash() { return 1881930374U; }
	UEnum* Z_Construct_UEnum_SteamCore_ESteamFavoriteFlags()
	{
		...
		if (!ReturnEnum)
		{
			...
			const UE4CodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
				...
				{ "ModuleRelativePath", "Public/ESteamFavoriteFlags.h" },
