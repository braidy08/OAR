...
#include "SteamCore/Public/IPCountry.h"
#ifdef _MSC_VER
#pragma warning (push)
#pragma warning (disable : 4883)
#endif
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeIPCountry() {}
...
static struct FScriptStruct_SteamCore_StaticRegisterNativesFIPCountry
{
	...
	{
		UScriptStruct::DeferCppStructOps<FIPCountry>(FName(TEXT("IPCountry")));
	}
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FIPCountry_Statics::Struct_MetaDataParams[] = {
		{ "BlueprintType", "true" },
		{ "ModuleRelativePath", "Public/IPCountry.h" },
	};
#endif
	...
	uint32 Get_Z_Construct_UScriptStruct_FIPCountry_Hash() { return 1513481093U; }
