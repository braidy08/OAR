...
#include "SteamCore/Public/RequestPlayersForGameProgressCallback.h"
#ifdef _MSC_VER
#pragma warning (push)
#pragma warning (disable : 4883)
#endif
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeRequestPlayersForGameProgressCallback() {}
...
static struct FScriptStruct_SteamCore_StaticRegisterNativesFRequestPlayersForGameProgressCallback
{
	...
	{
		UScriptStruct::DeferCppStructOps<FRequestPlayersForGameProgressCallback>(FName(TEXT("RequestPlayersForGameProgressCallback")));
	}
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FRequestPlayersForGameProgressCallback_Statics::Struct_MetaDataParams[] = {
		{ "BlueprintType", "true" },
		{ "ModuleRelativePath", "Public/RequestPlayersForGameProgressCallback.h" },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FRequestPlayersForGameProgressCallback_Statics::NewProp_Result_MetaData[] = {
		...
		{ "Category", "RequestPlayersForGameProgressCallback" },
		{ "ModuleRelativePath", "Public/RequestPlayersForGameProgressCallback.h" },
	};
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FRequestPlayersForGameProgressCallback_Statics::NewProp_Result = { "Result", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRequestPlayersForGameProgressCallback, Result), Z_Construct_UEnum_SteamCore_ESteamResult, METADATA_PARAMS(Z_Construct_UScriptStruct_FRequestPlayersForGameProgressCallback_Statics::NewProp_Result_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRequestPlayersForGameProgressCallback_Statics::NewProp_Result_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FRequestPlayersForGameProgressCallback_Statics::NewProp_SearchID = { "SearchID", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRequestPlayersForGameProgressCallback, SearchID), METADATA_PARAMS(Z_Construct_UScriptStruct_FRequestPlayersForGameProgressCallback_Statics::NewProp_SearchID_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRequestPlayersForGameProgressCallback_Statics::NewProp_SearchID_MetaData)) };
	...
	uint32 Get_Z_Construct_UScriptStruct_FRequestPlayersForGameProgressCallback_Hash() { return 3064720072U; }
