...
#include "SteamCore/Public/SteamItemDef.h"
#ifdef _MSC_VER
#pragma warning (push)
#pragma warning (disable : 4883)
#endif
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeSteamItemDef() {}
...
static struct FScriptStruct_SteamCore_StaticRegisterNativesFSteamItemDef
{
	...
	{
		UScriptStruct::DeferCppStructOps<FSteamItemDef>(FName(TEXT("SteamItemDef")));
	}
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FSteamItemDef_Statics::Struct_MetaDataParams[] = {
		{ "BlueprintType", "true" },
		{ "ModuleRelativePath", "Public/SteamItemDef.h" },
	};
#endif
	...
	uint32 Get_Z_Construct_UScriptStruct_FSteamItemDef_Hash() { return 4199698384U; }
