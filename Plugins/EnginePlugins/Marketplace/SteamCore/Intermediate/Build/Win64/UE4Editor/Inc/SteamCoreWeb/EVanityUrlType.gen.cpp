...
#include "SteamCoreWeb/Public/EVanityUrlType.h"
#ifdef _MSC_VER
#pragma warning (push)
#pragma warning (disable : 4883)
#endif
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeEVanityUrlType() {}
...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_SteamCoreWeb_EVanityUrlType_Hash() { return 1291703310U; }
	UEnum* Z_Construct_UEnum_SteamCoreWeb_EVanityUrlType()
	{
		...
		if (!ReturnEnum)
		{
			...
			const UE4CodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
				...
				{ "ModuleRelativePath", "Public/EVanityUrlType.h" },
