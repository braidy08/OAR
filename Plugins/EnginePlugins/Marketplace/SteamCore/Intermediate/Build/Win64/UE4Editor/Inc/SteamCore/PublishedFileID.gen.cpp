...
#include "SteamCore/Public/PublishedFileID.h"
#ifdef _MSC_VER
#pragma warning (push)
#pragma warning (disable : 4883)
#endif
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodePublishedFileID() {}
...
static struct FScriptStruct_SteamCore_StaticRegisterNativesFPublishedFileID
{
	...
	{
		UScriptStruct::DeferCppStructOps<FPublishedFileID>(FName(TEXT("PublishedFileID")));
	}
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FPublishedFileID_Statics::Struct_MetaDataParams[] = {
		{ "BlueprintType", "true" },
		{ "ModuleRelativePath", "Public/PublishedFileID.h" },
	};
#endif
	...
	uint32 Get_Z_Construct_UScriptStruct_FPublishedFileID_Hash() { return 2494718472U; }
